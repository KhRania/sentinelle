...
const cameraBaseURL1 = 'http://' + ip + ':' + port.camerathermique;
...
const frame1 = (params, cb) =>
{
	const req = {};
	req.url = cameraBaseURL1 + '/snapshot.jpg' + urlEncode(params);
	req.encoding = null;
	sendRequest(req, cb);
};
...
module.exports = {api, frame, config,frame1};